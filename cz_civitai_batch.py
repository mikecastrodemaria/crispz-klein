"""crispz-klein — batch CivitAI enrichment (standalone, no torch import → starts fast).
...
def main(argv=None):
    ...
    for _s in (sys.stdout, sys.stderr):
        try:
            ...
            pass
    ap = argparse.ArgumentParser(description="Batch CivitAI enrichment for crispz-klein "
