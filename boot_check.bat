@echo off
REM Boot check generique crispz-klein (remplace les anciens scripts rtx5090).
REM
...
if defined EXPOSE (
    ...
    echo  crispz-klein n'a AUCUNE authentification et sert ton dossier de
...
echo ====================================================
echo    Checks OK. Lancement de crispz-klein...
echo ====================================================
