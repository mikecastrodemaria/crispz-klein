"""crispz-klein - Asset Browser (standalone SPA in the output folder).
...
def ab_build_catalog(output_dir, loras_dir, checkpoints_dir):
    ...
    onglets LoRAs / Models de l'Asset Browser). Les deux arguments de dossiers
    acceptent une liste: les dossiers "extra" comptent autant que le principal.""" 
    d = _ab_resolve_dir(output_dir)
