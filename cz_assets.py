"""crispz-klein - UI/static assets (pure strings, no logic).
...
<title>crispz-klein - Asset Browser</title>
<style>
...
else grid.innerHTML='<p style="padding:20px;color:#8b98ad">No index yet. Click Reindex in crispz-klein.</p>';});}
