@echo off
REM Update crispz-klein (Windows): recupere les commits GitHub puis remet les
...
!RUNPY! -c "from diffusers import Flux2KleinPipeline, Flux2KleinInpaintPipeline; print('diffusers: FLUX.2 Klein pipelines OK')"
if errorlevel 1 (
    echo [ERREUR] diffusers ne fournit plus les pipelines FLUX.2 Klein.
